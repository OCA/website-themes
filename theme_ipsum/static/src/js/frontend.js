/* global Swiper */
odoo.define("theme_ipsum.frontend", function(require) {
    "use strict";
    ...
    ajax.loadXML("/theme_ipsum/static/src/xml/frontend.xml", qweb);

    snippetAnimation.registry.snippetContributors = snippetAnimation.Animation.extend({
        selector: ".snippet_ipsum_contributors",
        ...
        _renderPosts: function(posts) {
            ...
            _.each(posts, function(post) {
                self.$swiperWrapper.append(
                    qweb.render("theme_ipsum.PostSlide", {
                        post: post,
                    })
                );
            });
    ...
    snippetAnimation.registry.snippetSiderbar = snippetAnimation.Animation.extend({
        selector: ".ipsum_snippet_sidebar",
        start: function() {
            this._super.apply(this, arguments);
