...
(function(global, factory) {
    ...
    function calcBrowser() {
        ...
        return {
            isEdge: Boolean(window.navigator.userAgent.match(/Edge/g)),
            isSafari: isSafari(),
    ...
    function attachEvents() {
        ...
        var capture = Boolean(params.nested); // Touch Events
    ...
    var Swiper = /* #__PURE__*/ (function() {
        ...
        _proto.changeDirection = function changeDirection(newDirection, needUpdate) {
            ...
            swiper.$el
                .removeClass(
                    String(swiper.params.containerModifierClass) + currentDirection
                )
                .addClass(String(swiper.params.containerModifierClass) + newDirection);
            swiper.emitContainerClasses();
    ...
    var Pagination = {
        ...
        init: function init() {
            ...
            if (params.type === "bullets" && params.dynamicBullets) {
                $el.addClass(String(params.modifierClass) + params.type + "-dynamic");
                swiper.pagination.dynamicBulletIndex = 0;
    ...
    var Zoom = {
        ...
        in: function _in(e) {
            ...
            gesture.$slideEl.addClass(String(params.zoomedSlideClass));
            var touchX;
            var touchY;
            var offsetX;
            var offsetY;
        ...
        out: function out() {
            ...
            gesture.$slideEl.removeClass(String(params.zoomedSlideClass));
            gesture.$slideEl = undefined;
        },
